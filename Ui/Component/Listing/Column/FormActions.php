...
use Lof\Gallery\Block\Adminhtml\Banner\Grid\Renderer\Action\UrlBuilder;
use Magento\Framework\UrlInterface;

class FormActions extends Column
{
    /** Url path */
    const FORM_URL_PATH_EDIT = 'lofgallery/banner/edit';
    const FORM_URL_PATH_DELETE = 'lofgallery/banner/delete';
