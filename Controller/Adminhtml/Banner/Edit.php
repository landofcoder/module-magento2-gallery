...
class Edit extends \Lof\Gallery\Controller\Adminhtml\Banner
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Lof_Gallery::banner_edit');
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('lofgallery_banner', $model);
