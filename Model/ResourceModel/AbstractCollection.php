...
abstract class AbstractCollection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    protected function performAfterLoad($tableName, $columnName)
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['gallery_entity_store' => $this->getTable($tableName)])
                ->where('gallery_entity_store.' . $columnName . ' IN (?)', $items);
     ...
     * @return void
     */
    protected function performAddStoreFilter($store, $withAdmin = true, $field='store_id')
    {
        ...
        $this->addFilter($field, ['in' => $store], 'public');
    }
    ...
    {
        if ($this->getFilter('store') || $this->getFilter('store_id')) {
            $this->getSelect()->join(
